...
export default function About() {
  return (
    <Layout
      meta={
        <Meta
          title="Terms & conditions - CoFoundersLab"
          description="Terms and conditions on CoFoundersLab, the leading entrepreneurial network where like-minded entrepreneurs connect, meet and collaborate."
        />
      }
    >
      <div className="bg-white">
        <div className="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
          ...
          <div className="prose max-w-7xl">
            ...
            <p>
              We use the term “Designated Countries” to refer to countries in
            ...
            <p>
              This Privacy Policy applies to CoFoundersLab.com,
              CoFoundersLab-branded apps, CoFoundersLab Learning &amp;
              Accelerator Programs, CoFoundersLab Advisors Network, and other
              CoFoundersLab-related sites, apps, communications and services
              (“Services”).
            </p>

            <h2>Data Controllers and Contracting Parties</h2>
            <p>
              If you reside in the “Designated Countries”: CFLAB LLC
              (“CoFoundersLab”) will be the controller of your personal data
            ...
            <p>
              If you reside outside of the Designated Countries: CoFoundersLab
              will be the controller of your personal data provided to, or
              collected by or for, or processed in connection with, our
              Services; you are entering into the User Agreement with
              CoFoundersLab.
            </p>
            <p>
              ...
              (which includes our Cookie Policy and other documents referenced
              in this Privacy Policy) and updates.
            </p>

            <h2>Change</h2>
            <p>
              Changes to the Privacy Policy apply to your use of our Services
              after the 1st of January 2020.
            </p>
            <p>
              CoFoundersLab (“we” or “us”) can modify this Privacy Policy, and
              if we make material changes to it, we will provide notice through
            ...
            <p>
              ...
              email address and/or mobile number, and a password. If you
              register for a premium Service, you will need to provide payment
              (e.g., credit card) and billing information.
            </p>
            <p>
              You create your CoFoundersLab profile (a complete profile helps
            ...
            <p>
              ...
              your education, work experience, skills, photo, city or area and
            ...
            <p>
              on your profile and to make that sensitive information public.
              Please do not post or add personal data to your profile that you
            ...
            <p>
              ...
              it to our Services, such as when you fill out a form, (e.g., with
              demographic data or salary), respond to a survey, or submit a
              resume. If you opt to import your address book, we receive your
              contacts (including contact information your service provider(s)
              or app automatically added to your address book when you
            ...
            <p>
              ...
              growing your network by suggesting connections for you and others,
              and by providing information about them, e.g. times, places,
            ...
            <h4>
              <strong>1.2 Data From Others</strong>
            </h4>
            ...
            <p>
              ...
              Services. Unless you opt-out, we collect public information about
              you, such as professional-related news and accomplishments (e.g.,
              patents granted, professional recognition, conference speakers,
            ...
            <p>
              ...
              Services, associate their contacts with Member profiles, or send
              ...
              Services, we will also collect “email header” information that we
              can associate with Member profiles.
            </p>
            <p>Others may sync their contacts or calendar with our Services.</p>
            ...
            <p>
              ...
              provided by us or our affiliates, including CoFoundersLab.
            </p>

            <h4>
              <strong>1.3 Service Use</strong>
            </h4>
            <p>
            ...
            <h4>
              <strong>1.5 Your Device and Location</strong>
            </h4>
            <p>
            ...
            <p>
              ...
              get a CoFoundersLab connection request, we track whether you have
              acted on it and will send you reminders. We also use automatic
              scanning technology on messages.
            </p>

            <h4>
              <strong>1.7 Workplace and School Provided Information</strong>
            </h4>
            <p>
            ...
            <p>
              Others buying our Services for your use, such as your employer or
              your school, provide us with personal data about you and your
              eligibility to use the Services that they purchase for use by
              their workers, students or alumni. For example, we will get
              contact information for “Company Page” administrators and for
              authorizing users of our premium Services, such as our recruiting,
              sales or learning products.
            </p>

            <h4>
              <strong>1.8 Sites and Services of Others</strong>
            </h4>
            <p>
              We get data when you visit sites that include our plugins, ads or
              cookies or log-in to others’ services with your CoFoundersLab
              account.
            </p>
            <p>
              We receive information about your visits and interaction with
              services provided by others when you log-in with CoFoundersLab or
              visit others’ services that include our plugins (such as “Share”),
              ads, cookies or similar technologies.
            </p>

            <h4>
              <strong>1.9 Other</strong>
            </h4>
            <p>
            ...
            <p>
              ...
              which may require the collection of new information. If we collect
            ...
            <p>
              ...
              profile, posted a blog, took a social action made new connections
            ...
            <p>
              ...
              opportunities. Your profile can be found by those looking to
              partner or be hired by you. We will use your data to recommend
              jobs or mentees, show you and others who work at a company, in an
              industry, function or location or have certain skills and
              connections. You can signal that you are interested in changing
              jobs and share information with job recruiters. We will use your
              data to recommend jobs to you and you to recruiters. We may use
              automated systems to profile and provide recommendations to help
            ...
            <h4>
              <strong>2.2 Premium Services</strong>
            </h4>
            <p>
            ...
            <h4>
              <strong>2.3 Communications</strong>
            </h4>
            <p>
            ...
            <p>
              ...
              our websites or apps, messages to your CoFoundersLab inbox, and
              other ways through our Services, including text messages and push
            ...
            <p>
              ...
              Services, including for example discussion and messages between
              connections.
            </p>

            <h4>
              <strong>2.4 Advertising</strong>
            </h4>
            <p>
            ...
            <ul>
              ...
              <li>
                ...
                watch, clicking on an ad, etc.), including as described in
                Section 1.3;
              </li>
              <li>
            ...
            <p>
              ...
              settings, if you take a social action on the CoFoundersLab
            ...
            <h4>
              <strong>2.6 Developing Services and Research</strong>
            </h4>
            ...
            <h4>
              <strong>2.7 Customer Support</strong>
            </h4>
            ...
            <ul>
              <li>
                ...
                re-shared anywhere (subject to your settings). Members, Visitors
                and others will be able to find and see your publicly-shared
                content, including your name (and photo if you have provided
                one).
              </li>
              <li>
                In a discussion, posts are visible to others in the group. Your
              ...
              <li>
                Subject to your settings, we let a Member know when you view
                their profile.
              </li>
              <li>
            ...
            <h4>
              <strong>3.2 Communication Archival</strong>
            </h4>
            <p>
            ...
            <h4>
              <strong>3.3 Others’ Services</strong>
            </h4>
            <p>
            ...
            <p>
              ...
              option to upload your CoFoundersLab contacts into its own service.
            ...
            <p>
              ...
              calendar applications that show a user a “mini” CoFoundersLab
              profile of the person they are meeting or messaging, social media
              aggregators, talent and lead managers). “Old” profile information
              remains on these services until they update their data cache with
              changes you made to your profile.
            </p>

            <h4>
              <strong>3.4 Related Services</strong>
            </h4>
            <p>
              We share your data across our different Services and
              CoFoundersLab-affiliated entities.
            </p>
            <p>
            ...
            <h4>
              <strong>3.6 Legal Disclosures</strong>
            </h4>
            <p>
            ...
            <p>
              ...
              protect the rights and safety of CoFoundersLab, our Members,
            ...
            <h4>
              <strong>3.7 Change in Control or Sale</strong>
            </h4>
            <p>
            ...
            <h3>
              <strong>4. Your Choices &amp; Obligations</strong>
            </h3>
            <h4>
              <strong>4.1 Data Retention</strong>
            </h4>
            <p>
            ...
            <p>
              ...
              for a new CoFounder every few years, we will retain your
              information and keep your profile open until you decide to close
              your account.
            </p>
            ...
            <ul>
              <li>
                Delete Data: You can ask us to erase or delete all or some of
                your personal data (e.g., if it is no longer necessary to
                provide Services to you).
              </li>
              <li>
                Change or Correct Data: You can edit some of your personal data
                through your account. You can also ask us to change, update or
                fix your data in certain cases, particularly if it’s inaccurate.
              </li>
              <li>
                Object to, or Limit or Restrict, Use of Data: You can ask us to
                stop using all or some of your personal data (e.g., if we have
                no legal right to keep using it) or to limit our use of it
                (e.g., if your personal data is inaccurate or unlawfully held).
              </li>
              <li>
                Right to Access and/or Take Your Data: You can ask us for a copy
                of your personal data and can ask for a copy of personal data
            ...
            <h4>
              <strong>4.3 Account Closure</strong>
            </h4>
            <p>We keep some of your data even after you close your account.</p>
            <p>
              If you choose to close your CoFoundersLab account, your personal
              data will generally stop being visible to others on our Services
              within 24 hours. We generally delete closed account information
            ...
            <p>
              ...
              updates or discussion posts) will remain visible after you closed
            ...
            <h4>
              <strong>4.4 Approved Partners Data Sharing</strong>
            </h4>
            <p>
              By opting in, you are approving CoFoundersLab to share data that
              is essential to engage in, use or partake in a service or feature
              provided by an approved partner company of CoFoundersLab.
              CoFoundersLab will only share vital data.
            </p>
            ...
            <h4>
              <strong>5.2. Cross-Border Data Transfers</strong>
            </h4>
            ...
            <h4>
              <strong>5.3 Lawful Bases for Processing</strong>
            </h4>
            <p>
            ...
            <p>
              At any time, you can withdraw consent you have provided by going
              to settings.
            </p>
            <p>
              ...
              performance of a contract with you (e.g. to deliver the
              CoFoundersLab Services you have requested)) and “legitimate
              interests”.
            </p>
            <p>
              ...
              info@cofounderslab.com.
            </p>

            <h4>
              <strong>5.4. Direct Marketing and Do Not Track Signals</strong>
            </h4>
            <p>
            ...
            <p>
              ...
              first contact CoFoundersLab. You can also reach us by physical
              mail at CoFoundersLab, 1925 Century Park E., Floor 16th, Los
