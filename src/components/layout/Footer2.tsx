...
export default function Footer() {
  ...
  return (
    <footer
      className="mt-[-40px] bg-[#F1F8FF] text-gray-900"
    ...
    >
      ...
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="text-center sm:text-left lg:grid lg:grid-cols-3 lg:gap-8">
          <div className="mt-12 md:grid md:grid-cols-2 md:gap-8 lg:col-span-3 lg:mt-0">
            ...
            <div className="flex space-x-10">
              <div className="sm:items-left mt-8 flex w-full flex-col items-start sm:mt-0 sm:w-1/2">
                <h4 className="w-full text-left font-sans text-sm font-semibold uppercase">
                  Join Newsletter
                </h4>
                <div className="mt-6 mb-6 flex flex-col items-start ">
                  <input
                    type="text"
                    className="inputFooter mb-2 h-[40px] w-full text-sm"
                    placeholder="Type Email Here"
                  ></input>
                  <span className="flex h-[40px] cursor-pointer items-center justify-center rounded-md bg-orange-600 px-8 text-sm text-white">
                    Subscribe
              ...
              <div className="sm:items-left mt-8 flex w-full flex-col items-start sm:mt-0 sm:w-1/2">
                ...
                <div className="mt-6 mb-6 flex flex-row items-start ">
                  {footerNavigation.social.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="mr-5 text-gray-400 last:mr-0 hover:text-gray-500 hover:opacity-50"
                      target="_blank"
                      rel="noreferrer"
                    >
        ...
        <div className="mt-12 block items-center justify-between pt-8 text-center sm:flex">
          ...
          <p className="text-base text-gray-900">
            Copyright &copy; {year} <a href="/">CoFoundersLab</a>
          </p>
          <p className="flex justify-between space-x-10 text-base text-gray-900">
